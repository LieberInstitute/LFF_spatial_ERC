...
sil <- map(clusters, ~silhouette(.x, dist_matrix))
silhouette_mean <- map(sil, ~mean(.x[, "sil_width"]))
...
ggsave(cluster_eval_k_vs_n, here(plot_dir, "cluster_eval_k_vs_n.png"))
...
ggsave(cluster_eval_k_vs_silh, here(plot_dir, "cluster_eval_k_vs_silh.png"))
...
ggsave(cluster_eval_n_vs_silh, here(plot_dir, "cluster_eval_n_vs_silh.png"))
