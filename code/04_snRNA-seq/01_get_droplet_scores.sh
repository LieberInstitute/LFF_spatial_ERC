...
all_manual_knee=(FALSE FALSE FALSE FALSE FALSE FALSE FALSE FALSE FALSE FALSE FALSE FALSE FALSE FALSE FALSE TRUE FALSE FALSE TRUE TRUE TRUE FALSE FALSE FALSE FALSE FALSE TRUE FALSE FALSE TRUE FALSE)

sample_id=${all_sample_id[$(( $SLURM_ARRAY_TASK_ID / 1 % 31 ))]}
sample_knee=${all_manual_knee[$(( $SLURM_ARRAY_TASK_ID / 1 % 31 ))]}
