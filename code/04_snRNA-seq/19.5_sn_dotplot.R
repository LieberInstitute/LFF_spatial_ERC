...
plot_dir <- here("plots", "04_snRNA-seq", "19.5_sn_dotplot")
...
lit_markers <- read_csv(here("processed-data","04_snRNA-seq", "00_lit_marker_genes", "lit_marker_summary.csv")) |>
    ...
    filter( gene_name %in% rowData(sce)$gene_name,
           ...
           grepl("Grubman|Davila-Velderrain", studies)
           ) |>
...
pdf(here(plot_dir, sprintf("sn_ct_broad_dotplot_lit_genes.pdf")), height = 8, width = 6)
sce |>
