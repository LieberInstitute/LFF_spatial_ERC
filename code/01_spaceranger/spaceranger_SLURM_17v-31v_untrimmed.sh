...
#SBATCH --mem=80G
#SBATCH -n 8
#SBATCH -o /dcs05/lieber/marmaypag/LFF_spatialERC_LIBD4140/LFF_spatial_ERC/code/01_spaceranger/logs/spaceranger_17v-31v_untrimmed_%a.txt
#SBATCH -e /dcs05/lieber/marmaypag/LFF_spatialERC_LIBD4140/LFF_spatial_ERC/code/01_spaceranger/logs/spaceranger_17v-31v_untrimmed_%a.txt
#SBATCH --array=1-15
...
## Read inputs from spaceranger_parameters_17v-31v.txt file
FILE=$(awk "NR==${SLURM_ARRAY_TASK_ID}" spaceranger_parameters_17v-31v_untrimmed.txt)
...
## Removed '--r1-length=26' argument previously used to fix length variations in R1 FASTQ file as the samples were re-sequenced without trimming. 
