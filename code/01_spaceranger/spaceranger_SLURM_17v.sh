...
#SBATCH --mem=80G
#SBATCH -n 8
#SBATCH -o /dcs05/lieber/marmaypag/LFF_spatialERC_LIBD4140/LFF_spatial_ERC/code/01_spaceranger/logs/spaceranger_%a_JME.txt
#SBATCH -e /dcs05/lieber/marmaypag/LFF_spatialERC_LIBD4140/LFF_spatial_ERC/code/01_spaceranger/logs/spaceranger_%a_JME.txt
#SBATCH --array=17
...
FILE=$(awk "NR==${SLURM_ARRAY_TASK_ID}" spaceranger_parameter_17v.txt)
