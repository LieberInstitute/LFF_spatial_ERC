...
#SBATCH -p shared
#SBATCH --mem=10G
#SBATCH --job-name=02_ldsc_anno-Visium_specificity
#SBATCH -c 1
#SBATCH -t 1-00:00:00
#SBATCH -o /dev/null
#SBATCH -e /dev/null
...
all_cluster=(Inhib_Sp09D09 L1_Sp09D05 L2.3_Sp09D01 L5_Sp09D03 L6_Sp09D04 LD_Sp09D02 Vasc_Sp09D08 WM_Sp09D06 WM.uf_Sp09D07)
cluster=${all_cluster[$(( $SLURM_ARRAY_TASK_ID / 1 % 9 ))]}

## Explicitly pipe script output to a log
log_path=logs/02_ldsc_anno-Visium_specificity_${cluster}_${SLURM_ARRAY_TASK_ID}.txt
...
BED_DIR="/dcs05/lieber/marmaypag/LFF_spatialERC_LIBD4140/LFF_spatial_ERC/processed-data/18_LDSC/01_prep_marker_bed/bed_specificity_Visium"
