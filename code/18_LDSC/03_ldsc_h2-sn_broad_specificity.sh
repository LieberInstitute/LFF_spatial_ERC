...
#SBATCH -p shared
#SBATCH --mem=10G
#SBATCH --job-name=03_ldsc_h2-sn_broad_specificity
#SBATCH -c 1
#SBATCH -t 1-00:00:00
#SBATCH -o /dev/null
#SBATCH -e /dev/null
...
cluster=${all_cluster[$(( $SLURM_ARRAY_TASK_ID / 1 % 8 ))]}

## Explicitly pipe script output to a log
log_path=logs/03_ldsc_h2-sn_broad_specificity_${cluster}_${SLURM_ARRAY_TASK_ID}.txt
