...
# slurmjobs::job_single('06_Clusterwise_voomLmFit_Xenium_Oligo.3_Astro', create_shell = TRUE, memory = '25G', command = "Rscript 06_Clusterwise_voomLmFit_Xenium_SpX.R --datatype Xenium_Oligo.3_Astro")
# slurmjobs::job_single('06_Clusterwise_voomLmFit_Xenium_cell_type_anno_SpX', create_shell = TRUE, memory = '25G', command = "Rscript 06_Clusterwise_voomLmFit_Xenium_SpX.R --datatype Xenium_cell_type_anno_SpX")
