...
lmf_summary <- map_dfr(clusters, function(clus){
    ...
    des <- model.matrix(~0+APOE_syn+Sex+Age+Anc_Afr, data = colData(dge))
    ...
    cont <- makeContrasts(
        E2E2_E4E4 = "-APOE_E2.E2 + APOE_E4.E4",
        E3E4_E4E4 = "-APOE_E3.E4 + APOE_E4.E4",
        E2E3_E4E4 = "-APOE_E2.E3 + APOE_E4.E4",
        E2E2_E3E4 = "-APOE_E2.E2 + APOE_E3.E4",
        E2E2_E2E3 = "-APOE_E2.E2 + APOE_E2.E3",
        E2E3_E3E4 = "-APOE_E2.E3 + APOE_E3.E4",
        anyE2_E4E4 = "- 0.5*(APOE_E2.E3 + APOE_E2.E2) + APOE_E4.E4",
        anyE2_anyE4 = "-0.5*(APOE_E2.E2 + APOE_E2.E3) + 0.5*(APOE_E3.E4 + APOE_E4.E4)",
        E2E2_anyE4 = "-APOE_E2.E2 + 0.5*(APOE_E3.E4 + APOE_E4.E4)",
        E2E3_anyE4 = "-APOE_E2.E3 + 0.5*(APOE_E3.E4 + APOE_E4.E4)",
        E4E4_other = "-APOE_E4.E4 + (APOE_E2.E2 + APOE_E2.E3 + APOE_E3.E4)/3",
        Sex=SexM,
        Anc=Anc_Afr,
        levels=des
    )
