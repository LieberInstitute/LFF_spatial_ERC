...
#### Set up dirs ####
data_dir <- here("processed-data", "12_voomLmFit", "04_Clusterwise_voomLmFit_path", sprintf("vlmf_%s", opt$datatype))
...
sce_pb$taupathy <- tau_tb[sce_pb$BrNum,]$taupathy

table(sce_pb$registration_variable, sce_pb$taupathy)
#       FALSE TRUE
# Astro    22    9
# Macro    15    4
# Micro    22    9
...
# slurmjobs::job_single('04_Clusterwise_voomLmFit_path_sn_broad', create_shell = TRUE, memory = '25G', command = "Rscript 04_Clusterwise_voomLmFit_path.R --datatype sn_broad")
# slurmjobs::job_single('04_Clusterwise_voomLmFit_path_sn_fine', create_shell = TRUE, memory = '10G', command = "Rscript 04_Clusterwise_voomLmFit_path.R --datatype sn_fine")
# slurmjobs::job_single('04_Clusterwise_voomLmFit_path_Visium', create_shell = TRUE, memory = '25G', command = "Rscript 04_Clusterwise_voomLmFit_path.R --datatype Visium")
