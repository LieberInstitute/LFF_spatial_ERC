## Louise Huuki-Myers, Nov 2024 - revised in Aug 2026 checking offset issue
...
plot_dir <- here("plots", "05_spe_correct_cluster", "05_BayesSpace_Marker_offset")
if(!dir.exists(plot_dir)) dir.create(plot_dir, showWarnings = FALSE, recursive = TRUE)

data_dir <- here("processed-data", "05_spe_correct_cluster", "05_BayesSpace_Marker_offset")
...
# slurmjobs::job_single('05_BayesSpace_Markers_cluster_offset', create_shell = TRUE, memory = '25G', command = "Rscript 05_BayesSpace_Markers_cluster_offset.R")
