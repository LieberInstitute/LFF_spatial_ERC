...
#### Set up dirs ####
data_dir <- here("processed-data", "11_dreamlet_Visium", "04_compile_dreamlet_Visium")
if (!dir.exists(data_dir)) dir.create(data_dir, recursive = TRUE)

plot_dir <- here("plots", "11_dreamlet_Visium", "04_compile_dreamlet_Visium")
...
# slurmjobs::job_single('04_compile_dreamlet_Visium', create_shell = TRUE, memory = '50G', command = "Rscript 04_compile_dreamlet_Visium.R")

# slurmjobs::job_loop(
#     loops = list(model = names(dreamlet_models_Visium)),
#     name = "04_compile_dreamlet_Visium",
#     create_shell = TRUE,
#     create_script = FALSE
# )
