...
#SBATCH -p shared
#SBATCH --mem=10G
#SBATCH --job-name=14_xenium_pseudobulk_model_register
#SBATCH -c 1
#SBATCH -t 1-00:00:00
#SBATCH -o logs/14_xenium_pseudobulk_model_register.txt
#SBATCH -e logs/14_xenium_pseudobulk_model_register.txt
